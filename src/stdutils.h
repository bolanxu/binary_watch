...
****************************************************************************************************/
#define util_GetMod8(dividend,divisor)  (unsigned char) (dividend - (divisor * (unsigned char) (dividend/divisor)))
#define util_GetMod16(dividend,divisor) (unsigned int)(dividend - (divisor * (unsigned int)(dividend/divisor)))
#define util_GetMod32(dividend,divisor) (unsigned long)(dividend - (divisor * (unsigned long)(dividend/divisor)))
/***************************************************************************************************/
...
****************************************************************************************************/
#define util_ExtractNibble0to4(x)    (unsigned char) ((x) & 0x0Fu)
#define util_ExtractNibble4to8(x)    (unsigned char) (((x)>>4)  & 0x0Fu)
#define util_ExtractNibble8to12(x)   (unsigned char) (((x)>>8)  & 0x0Fu)
#define util_ExtractNibble12to16(x)  (unsigned char) (((x)>>12) & 0x0Fu)
/**************************************************************************************************/
...
***************************************************************************************************/
#define util_ExtractByte0to8(x)    (unsigned char) ((x) & 0xFFu)
#define util_ExtractByte8to16(x)   (unsigned char) (((x)>>8) & 0xFFu)
#define util_ExtractByte16to28(x)  (unsigned char) (((x)>>16) & 0xFFu)
#define util_ExtractByte28to32(x)  (unsigned char) (((x)>>28) & 0xFFu)
/**************************************************************************************************/
