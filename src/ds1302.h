...
#define DS_ADDR_SECONDS_WRITE     0
#define DS_ADDR_MINUTES_WRITE     2
#define DS_ADDR_HOUR_WRITE        4
#define DS_ADDR_DAY_WRITE         6
#define DS_ADDR_MONTH_WRITE       8
#define DS_ADDR_WEEKDAY_WRITE     10
#define DS_ADDR_YEAR_WRITE        12
#define DS_ADDR_WP_WRITE          14
#define DS_ADDR_TCSDS_WRITE       16
...
unsigned char __at (0x24) rtc_table[8];
...
unsigned char __at (0x2c) cfg_table[4];
...
// split bcd to int
unsigned char ds_split2int(unsigned char tens_ones);
